# -*- coding: utf-8 -*-
"""
Created on Fri Sep  7 12:17:47 2018
...
def get_face(image, image_size=160, minsize=20, path=True):
    ...
    if nrof_faces>0:
        ...
        for i, det in enumerate(det_arr):
            ...
            face = misc.imresize(cropped, (image_size, image_size), interp='bilinear')
            faces.append(face)
    else:
